...
import ir.co.persiancalendar.core.exceptions.DayOutOfRangeException;
import ir.co.persiancalendar.core.interfaces.OnDayClickedListener;
import ir.co.persiancalendar.core.interfaces.OnDayLongClickedListener;
import ir.co.persiancalendar.core.interfaces.OnEventUpdateListener;
import ir.co.persiancalendar.core.interfaces.OnMonthChangedListener;
import ir.co.persiancalendar.core.models.AbstractDate;
import ir.co.persiancalendar.core.models.CalendarEvent;
import ir.co.persiancalendar.core.models.CivilDate;
import ir.co.persiancalendar.core.models.Day;
import ir.co.persiancalendar.core.models.IslamicDate;
import ir.co.persiancalendar.core.models.PersianDate;
import ir.co.persiancalendar.helpers.ArabicShaping;
import ir.co.persiancalendar.helpers.DateConverter;
...
//        String allEvents = G.EVENTS.getString("key","empty");
//        try {
//            events = new JSONArray(allEvents);
//        } catch (JSONException e) {
//            events = new JSONArray();
//        }
//
//        JSONObject title = new JSONObject((Map) event);
//        events.put(title);
//        G.EVENTS.edit().putString("key", String.valueOf(events));
//        G.EVENTS.edit().apply();
