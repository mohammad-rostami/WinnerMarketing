...
public class AddCustomerActivity extends Activity {
    ...
    public static AddCustomerActivity activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar_main_tv_header.setText("مشتری جدید");
        ...
        // Dialog
        dialogVerify = new Dialog(AddCustomerActivity.this);
...
//                dialogVerify_txt_counter.setText(String.valueOf("00:" + millisUntilFinished / 1000));
        ...
        // Dialog
        dialogSuccess = new Dialog(AddCustomerActivity.this);
...
//        dialogSuccess.setTitle("Custom Dialog");
        ...
        dialogSuccess_btn_register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddCustomerActivity.this, ProjectsActivity.class);
        ...
        // Dialog
        dialogDateSelector = new Dialog(AddCustomerActivity.this);
        ...
        activityRegister_btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fieldsAreFilled) {
                    try {
                        if (ActivityCompat.checkSelfPermission(AddCustomerActivity.this, mPermission[0]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(AddCustomerActivity.this, mPermission[1]) != MockPackageManager.PERMISSION_GRANTED ||
                                ActivityCompat.checkSelfPermission(AddCustomerActivity.this, mPermission[2]) != MockPackageManager.PERMISSION_GRANTED) {
                            ActivityCompat.requestPermissions(AddCustomerActivity.this, mPermission, REQUEST_CODE_PERMISSION);
...
//        finish();
    ...
    public void runSessionService() {
        ...
        new newAsync().execute(Urls.BASE_URL + Urls.REGISTER_BUYER, sessionId, userToken, customerId, firstName, selectedCity);
...
//                cityName.add(title);
    ...
    private class newAsync extends Webservice.registerBuyer {
        @Override
    ...
    private class resendAsync extends Webservice.resend {
        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                Toast.makeText(AddCustomerActivity.this, result, Toast.LENGTH_SHORT).show();
...
//                    finish();
    ...
    public static void addCustomerResult(int responseCode) {
        if (responseCode == 200) {
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(G.CONTEXT, "ثبت مشتری با موفقیت انجام شد", Toast.LENGTH_SHORT).show();
                }
            });
            activity.finish();
            CustomerActivity.restartActivity();

        } else {
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    Toast.makeText(G.CONTEXT, "خطا در ثبت مشتری", Toast.LENGTH_SHORT).show();
                }
            });
        }
